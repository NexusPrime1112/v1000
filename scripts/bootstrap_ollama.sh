...
BOOT_TIMEOUT_SECONDS="${NEXUS_OLLAMA_BOOT_TIMEOUT_SECONDS:-90}"
STRICT_BOOTSTRAP="${NEXUS_OLLAMA_BOOTSTRAP_STRICT:-0}"
PREFER_LOCAL="${NEXUS_PREFER_LOCAL_OLLAMA:-1}"
...
if [[ "${PREFER_LOCAL}" == "1" && "${NEXUS_ENABLE_LOCAL_OLLAMA:-1}" == "1" ]]; then
  unset OLLAMA_HOST
fi
...
if [[ "${NEXUS_ENABLE_LOCAL_OLLAMA:-1}" != "1" ]]; then
...
seen = set()
sources = [
    os.environ.get("NEXUS_BOOTSTRAP_MODELS", ""),
    os.environ.get("NEXUS_OLLAMA_MODELS", ""),
    os.environ.get("NEXUS_PRIMARY_MODEL", ""),
    os.environ.get("NEXUS_MODEL_DIRECTOR", ""),
    os.environ.get("NEXUS_MODEL_PLANNING", ""),
    os.environ.get("NEXUS_MODEL_TREND", ""),
    os.environ.get("NEXUS_MODEL_CREATOR", ""),
    os.environ.get("NEXUS_MODEL_REPHRASE", ""),
    os.environ.get("NEXUS_MODEL_SELECTOR", ""),
    os.environ.get("NEXUS_MODEL_CODING", ""),
    os.environ.get("NEXUS_MODEL_SUMMARY", ""),
    os.environ.get("NEXUS_MODEL_CHAT", ""),
    os.environ.get("NEXUS_MODEL_DEBUG", ""),
    os.environ.get("NEXUS_MODEL_QUICK", ""),
]
for raw in sources:
